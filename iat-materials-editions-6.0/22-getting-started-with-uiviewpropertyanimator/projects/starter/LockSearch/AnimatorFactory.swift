...
//  Widgets
//
//  Created by Santiago Pelaez Rua on 11/02/21.
...
class AnimatorFactory {
  ...
  @discardableResult static func jiggle(view: UIView) -> UIViewPropertyAnimator {
    return UIViewPropertyAnimator.runningPropertyAnimator(withDuration: 0.33,
                                                          delay: 0) {
  ...
  @discardableResult static func fade(view: UIView, visible blurred: Bool) -> UIViewPropertyAnimator {
